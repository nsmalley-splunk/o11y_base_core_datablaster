...
## Steps for Splunk Demo Usage: Install Steps: 
   7. Install Customer Command / Script 
        1. Copy the local directory content into a local app directory - (ensure the $SPLUNK_HOME/etc/apps/your APP/local/ - (PRO TIP: install in an app that has global visibility)
            1. commands.conf 
        ...
        2. Copy the bin directory content (2 locations: $SPLUNK_HOME/bin/scripts '|' $SPLUNK_HOME/etc/apps/your APP /bin/)
            1. event_status.py
